...
const TextInput = ({
  ...
  return (
    <myStyled.baseContainer className="textInput" labelColor={labelColor} textColor={textColor} disabledTextColor={disabledTextColor} borderBottomColor={borderBottomColor}>
      {icon}
      <TextField name={name} key={key} id={id} label={label} value={value} onChange={onChange} onBlur={onBlur} type={isPassword ? "password" : "text"} onKeyPress={onKeyPress} data-testid={testid} multiline={isMultiLine} minRows={5} />
